...
if ( ! function_exists( 'hendon_core_add_link_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function hendon_core_add_link_typography_options( $page ) {
		
		if ( $page ) {
			$link_tab = $page->add_tab_element( array(
				'name'        => 'tab-link',
				'icon'        => 'fa fa-cog',
				'title'       => esc_html__( 'Link Typography', 'hendon-core' ),
				'description' => esc_html__( 'Set values for link', 'hendon-core' )
			) );
			...
			$link_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Text Decoration', 'hendon-core' ),
					'options'    => hendon_core_get_select_type_options_pool( 'text_decoration' ),
					'args'       => array(
						'col_width' => 4
					)
				)
			...
			$link_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Hover Text Decoration', 'hendon-core' ),
					'options'    => hendon_core_get_select_type_options_pool( 'text_decoration' ),
					'args'       => array(
						'col_width' => 4
					)
	...
	add_action( 'hendon_core_action_after_typography_options_map', 'hendon_core_add_link_typography_options' );
}
...
if ( ! function_exists( 'hendon_core_add_linear_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function hendon_core_add_linear_icons_to_collection( $icons ) {
		$icons[] = 'HendonCoreLinearIconsPack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'hendon_core_add_linear_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class HendonCoreLinearIconsPack extends QodeFrameworkIconPack {

...
if ( class_exists( 'HendonCoreDashboardRestAPI' ) ) {
	class HendonCoreRestAPIRegistrationPurchaseCode extends HendonCoreDashboardRestAPI {
		...
		public function register_rest_api_route() {
			...
			register_rest_route( $this->get_namespace(), $this->get_route(), array(
				array(
					...
					'callback' => array( HendonCoreDashboard::get_instance(), 'purchase_code_registration' ),
	...
	HendonCoreRestAPIRegistrationPurchaseCode::get_instance();
}
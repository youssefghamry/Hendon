...
if ( ! class_exists( 'HendonCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class HendonCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'hendon_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
	...
	HendonCoreDashboardRestAPI::get_instance();
}
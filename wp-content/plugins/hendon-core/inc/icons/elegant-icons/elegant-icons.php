...
if ( ! function_exists( 'hendon_core_add_elegant_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function hendon_core_add_elegant_icons_to_collection( $icons ) {
		$icons[] = 'HendonCoreElegantIconsPack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'hendon_core_add_elegant_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class HendonCoreElegantIconsPack extends QodeFrameworkIconPack {

<div <?php qode_framework_class_attribute( $holder_classes ); ?>>
	<?php hendon_core_template_part( 'shortcodes/banner', 'templates/parts/image', '', $params ) ?>
	...
	<?php hendon_core_template_part( 'shortcodes/banner', 'templates/parts/link', '', $params ) ?>
</div>
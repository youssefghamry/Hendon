<?php
$apartment_list_image = get_post_meta( get_the_ID(), 'qodef_apartment_list_image', true );
...
if ( $has_image ) {
	...
	<div class="qodef-e-media-image">
		<a itemprop="url" href="<?php the_permalink(); ?>">
			<?php echo hendon_core_get_list_shortcode_item_image( $image_dimension, $apartment_list_image, $custom_image_width, $custom_image_height ); ?>
		</a>
	</div>
<?php } ?>
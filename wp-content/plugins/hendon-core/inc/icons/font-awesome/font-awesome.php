...
if ( ! function_exists( 'hendon_core_add_font_awesome_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function hendon_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'HendonCoreFontAwesomePack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'hendon_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class HendonCoreFontAwesomePack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return HENDON_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
		...
		function get_new_icons_list() {
			$icons     = '';
			$new_icons = @file_get_contents( HENDON_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/icons.json' );

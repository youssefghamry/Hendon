...
if ( ! function_exists( 'hendon_core_add_h1_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function hendon_core_add_h1_typography_options( $page ) {
		...
		if ( $page ) {
			$h1_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h1',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H1 Typography', 'hendon-core' ),
					'description' => esc_html__( 'Set values for Heading 1 HTML element', 'hendon-core' )
				)
			);
	...
	add_action( 'hendon_core_action_after_typography_options_map', 'hendon_core_add_h1_typography_options' );
}